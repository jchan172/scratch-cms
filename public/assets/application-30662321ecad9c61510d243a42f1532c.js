...
(function(b){b.extend(b.rsProto,{_o5:function(){var a=this,g,c,e;a._p5={enabled:!1,change:!1,prefix:""};a.st.deeplinking=b.extend({},a._p5,a.st.deeplinking);if(a.st.deeplinking.enabled){var h=a.st.deeplinking.change,d=a.st.deeplinking.prefix,f="#"+d,j=function(){var a=window.location.hash;return a&&0<a.indexOf(d)&&(a=parseInt(a.substring(f.length),10),0<=a)?a-1:-1},k=j();-1!==k&&(a.st.startSlideId=k);h&&(b(window).on("hashchange"+a.ns,function(){if(!g){var b=j();0>b||(b>a.numSlides-1&&(b=a.numSlides-
1),a.goTo(b))}}),a.ev.on("rsBeforeAnimStart",function(){c&&clearTimeout(c);e&&clearTimeout(e)}),a.ev.on("rsAfterSlideChange",function(){c&&clearTimeout(c);e&&clearTimeout(e);e=setTimeout(function(){g=!0;window.location.replace((""+window.location).split("#")[0]+f+(a.currSlideId+1));c=setTimeout(function(){g=!1;c=null},60)},400)}));a.ev.on("rsBeforeDestroy",function(){c=e=null;h&&b(window).off("hashchange"+a.ns)})}}});b.rsModules.deeplinking=b.rsProto._o5})(jQuery);
(function(b,a,g){function c(a){a=a||location.href;return"#"+a.replace(/^[^#]*#?(.*)$/,"$1")}"$:nomunge";var e=document,h,d=b.event.special,f=e.documentMode,j="onhashchange"in a&&(f===g||7<f);b.fn.hashchange=function(a){return a?this.bind("hashchange",a):this.trigger("hashchange")};b.fn.hashchange.delay=50;d.hashchange=b.extend(d.hashchange,{setup:function(){if(j)return!1;b(h.start)},teardown:function(){if(j)return!1;b(h.stop)}});var k=function(){var e=c(),d=r(p);e!==p?(q(p=e,d),b(a).trigger("hashchange")):
d!==p&&(location.href=location.href.replace(/#.*/,"")+d);m=setTimeout(k,b.fn.hashchange.delay)},d={},m,p=c(),q=f=function(a){return a},r=f;d.start=function(){m||k()};d.stop=function(){m&&clearTimeout(m);m=g};if(a.attachEvent&&!a.addEventListener&&!j){var l,n;d.start=function(){l||(n=(n=b.fn.hashchange.src)&&n+c(),l=b('<iframe tabindex="-1" title="empty"/>').hide().one("load",function(){n||q(c());k()}).attr("src",n||"javascript:0").insertAfter("body")[0].contentWindow,e.onpropertychange=function(){try{"title"===
event.propertyName&&(l.document.title=e.title)}catch(a){}})};d.stop=f;r=function(){return c(l.location.href)};q=function(a,d){var c=l.document,f=b.fn.hashchange.domain;a!==d&&(c.title=e.title,c.open(),f&&c.write('<script>document.domain="'+f+'"\x3c/script>'),c.close(),l.location.hash=a)}}h=d})(jQuery,this);
